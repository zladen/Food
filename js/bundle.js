...
function modal(triggerSelecctor, modalSelector, modalTimerId) {
    const modalTrigger = document.querySelectorAll(triggerSelecctor),
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    function slidesFieldTranslateX() {
        slidesField.style.transform = `translateX(-${offset}px)`;
    }

    // function slideIndexIncr() {
    //     if (slideIndex == 1) {
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '22-05-31');
